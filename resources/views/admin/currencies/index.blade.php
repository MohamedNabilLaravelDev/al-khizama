...
<x-admin.table datefilter="true" order="true" extrabuttons="true"
  addbutton="{{ route('admin.currencies.create') }}"
  deletebutton="{{ route('admin.currencies.deleteAll') }}" :searchArray="[
        'country_name' => [
            'input_type' => 'text' , 
            'input_name' => __('admin.country_name') , 
        ] ,
...
@include('admin.shared.filter_js' , [ 'index_route' => url('admin/currencies')])
@endsection