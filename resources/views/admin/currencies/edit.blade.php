              ...
              <div class="textCenter">
                <div class="imagesUploadBlock">
                  <label class="uploadImg">
                    ...
                    <input type="file" accept="image/*" name="country_flag"
                      enctype="multipart/form-data" class="imageUploader">
                  </label>
                  <div class="uploadedBlock">
                    <img src="{{$currency->country_flag}}">
          ...
          <div class="card-body">
            ...
            <div class="form-body">
              <div class="row">
                    ...
                    <div role="tabpanel"
                      ...
                      <div class="col-md-12 col-12">
                        <div class="form-group">
                          <label for="first-name-column">{{__('admin.currencyName')}}
                            {{ $lang }}</label>
                          <div class="controls">
                            <input type="text"
                      ...
                      <div class="col-md-12 col-12">
                        <div class="form-group">
                          <label for="first-name-column">{{__('admin.country_name')}}
                            {{ $lang }}</label>
                          <div class="controls">
                            <input type="text"
                              value="{{$currency->getTranslations('country_name')[$lang]??''}}"
                              name="country_name[{{$lang}}]" class="form-control"
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="selling_price" class="form-control"
                        ...
                        placeholder="{{__('admin.selling_price')}}" required
                        data-validation-required-message="{{__('admin.this_field_is_required')}}">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4 col-12">
                  <div class="form-group">
                    <label for="first-name-column">{{__('admin.buying_price')}}</label>
                    <div class="controls">
                      <input type="text" name="buying_price" class="form-control"
                        value="{{$currency->selling_price}}"
                        placeholder="{{__('admin.buying_price')}}" required
                        data-validation-required-message="{{__('admin.this_field_is_required')}}">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-4 col-12">
                  <div class="form-group">
                    <label for="first-name-column">{{__('admin.currencyCode')}}</label>
                    <div class="controls">
                      <input type="text" name="code" class="form-control"
                        value="{{$currency->code}}" placeholder="{{__('admin.code')}}"
                        required
                        data-validation-required-message="{{__('admin.this_field_is_required')}}">
                    </div>
                  </div>
