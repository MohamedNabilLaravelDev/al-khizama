...
@section('content')
<form method="POST" action="{{route('admin.holidays.update' , ['id' => $holiday->id])}}"
        ...
        <div class="card-body">
          ...
          <div class="form-body">
            <div class="row">
                  ...
                  <div role="tabpanel"
                    ...
                    <div class="col-md-12 col-12">
                      <div class="form-group">
                        <label for="first-name-column">{{__('admin.title')}}
                          {{ $lang }}</label>
                        <div class="controls">
                          <input type="text"
                    ...
                    <div class="col-md-12 col-12">
                      <div class="form-group">
                        <label for="first-name-column">{{__('admin.description')}}
                          {{ $lang }}</label>
                        <div class="controls">
              ...
              <div class="col-md-12 col-12">
                <div class="form-group">
                  <label for="first-name-column">{{__('admin.date')}}
                    {{ $lang }}</label>
                  <div class="controls">
              ...
              <div class="col-md-12 col-12">
                <div class="form-group">
                  <label for="first-name-column">{{__('admin.is_active')}} :</label>
                  {{-- <div class="controls"> --}}
                  <label class="switch">
