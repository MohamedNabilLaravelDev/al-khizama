...
<x-admin.table datefilter="true" order="true" extrabuttons="true"
  addbutton="{{ route('admin.holidays.create') }}"
  deletebutton="{{ route('admin.holidays.deleteAll') }}" :searchArray="[
        'name' => [
            'input_type' => 'text' , 
...
@include('admin.shared.filter_js' , [ 'index_route' => url('admin/holidays')])
@endsection