                                ...
                                <form accept="{{route('admin.settings.update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label for="account-name">{{__('admin.app_fees')}}</label>
                                                    <input type="number" class="form-control" name="app_fees" id="account-name" placeholder="{{__('admin.app_fees')}}" value="{{$data['app_fees']}}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <label for="account-name">{{__('admin.default_transfer_currency')}}</label>
                                                    <select name="default_transfer_currency" class="form-control select2">
