...
<x-admin.table datefilter="true" order="true"
  addbutton="{{ route('admin.offers.create') }}"
  deletebutton="{{ route('admin.offers.deleteAll') }}" :searchArray="[
        'title' => [
            'input_type' => 'text' , 
...
{{-- delete one user script --}}
@include('admin.shared.filter_js' , [ 'index_route' => url('admin/offers')])
{{-- delete one user script --}}
@endsection