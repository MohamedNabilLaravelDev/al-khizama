...
use App\Http\Controllers\Api\TransferTransactionController;
...
Route::group([
  ...
  Route::group(['middleware' => ['auth:sanctum', 'is-active']], function () {
    ...
    Route::get('deliveryDate', [MainController::class, 'deliveryDate']);
    Route::post('dateIntervals', [MainController::class, 'dateIntervals']);
    Route::post('changeCurrency', [TransferTransactionController::class, 'changeCurrency']);
    Route::post('makeTransfer', [TransferTransactionController::class, 'makeTransfer']);
    Route::post('transferSummary', [TransferTransactionController::class, 'transferSummary']);
    Route::post('showTransferById', [TransferTransactionController::class, 'showTransferById']);
    Route::get('myTransactions', [TransferTransactionController::class, 'myTransactions']);
    /***************************** appServices end *****************************/
